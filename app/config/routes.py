...
# routes['VERB']['/your/custom/route'] = 'Controller#method'
# setting a custom route without a specific verb defaults to GET
# routes['/your/custom/route'] = 'Controller#method' # this is a GET route (we didn't have to specify
"""
